...
export default function TradingJournal() {
  ...
  >([]);
  const [journalEntries, setJournalEntries] = useState<JournalEntry[]>([]); // New state for journal entries
  ...
  const handleClearData = () => {
    ...
    setDeposits([]);
    setBalance(0);
    setJournalEntries([]); // Clear journal entries state
      ...
      case "settings":
        return (
          <DataManager
            ...
            deposits={deposits}
            balance={balance}
            journalEntries={journalEntries} // Pass journal entries to DataManager
