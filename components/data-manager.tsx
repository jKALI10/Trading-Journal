...
interface DataManagerProps {
  ...
  deposits: any[];
  balance: number;
  journalEntries: any[]; // Add journalEntries to props
  onImportData: (data: {
    trades: any[];
    deposits: any[];
    balance: number;
...
export function DataManager({
  ...
  const exportData = () => {
    const data = {
      ...
      deposits,
      balance,
      journalEntries, // Include journalEntries in export
    ...
    a.href = url;
    a.download = `trading-journal-backup-${
  ...
  const importData = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    reader.onload = (e) => {
      try {
        ...
        // Validate data structure and include journalEntries
        if (data.trades && data.deposits && typeof data.balance === "number") {
          onImportData({
            trades: data.trades,
            deposits: data.deposits,
            balance: data.balance,
            journalEntries: data.journalEntries || [], // Ensure journalEntries are included, default to empty array
          });
  ...
  const handleClearData = () => {
    ...
    localStorage.removeItem("trading-journal-journal-entries"); // Clear journal entries from localStorage

    toast({
      title: "Data Cleared",
      description:
        "All your trading data has been cleared. The page will refresh.",
    });
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">
          Backup, restore, sync, and manage your trading data
        </p>
      </div>
      ...
      <div className="grid gap-6 md:grid-cols-2">
            ...
            <div className="space-y-4">
              <div className="text-sm text-muted-foreground space-y-2">
                ...
                <div className="space-y-1">
                  ...
                  <div>• {journalEntries.length} journal entries</div>{" "}
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Restore your trading data from a backup file
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
            ...
            <AlertDialogContent>
              <AlertDialogHeader>
                ...
                <AlertDialogDescription>
                  ...
                  your trading history ({trades.length} trades), deposit records
                  ({deposits.length} deposits), journal entries (
                  {journalEntries.length} entries), account balance ($
                  {balance.toFixed(2)}), and all analytics and progress data.
                </AlertDialogDescription>
              </AlertDialogHeader>
              <AlertDialogFooter>
          ...
          <div className="space-y-3 text-sm">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  Your data is stored locally in your browser and never sent to
                  external servers.
                </p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  Securely sync your data across multiple devices using
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  Local data is tied to this specific browser. Use cloud sync or
                  exports for cross-device access.
                </p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  Regular exports and cloud sync are recommended to prevent data
                  loss.
                </p>
              </div>
            </div>
